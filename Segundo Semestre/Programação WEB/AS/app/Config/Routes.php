 ...
 * --------------------------------------------------------------------
 */
$routes->setDefaultNamespace('App\Controllers');//sistema de nomenclatura para fazer a chamada de página
...
$routes->get('/clients/(:num)', 'Clients::detailsClients/$1');

 //aqui irá listar o cliente e informar os detalhes
...
$routes->add('/admin/clients/(:num)','Admin\Clients::detailsClients/$1');
